...
public class gdCross_bt implements calcIndicator_bt {
	...
	public gdCross_bt(int longd, int shortd, int mT,CryptowatchAPI c, String e, String coin, String base, int interval, double[][] hArr, int initialStart, int initialEnd) throws Exception {
		this.longd = longd;
		this.shortd = shortd;
		this.crypt = c;
		this.exchange = e;
